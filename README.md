...
The measured Phase 9 baseline run is roughly six minutes. Phase 10 is planned around expedition depth and shipcraft: multi-stage mission graphs, modular frames and hardpoints, deterministic salvage engineering and weapon evolution, capital-ship/station set pieces, run-local faction rivals, crew/wingmates, and a local Scenario Lab. The initial structural target is roughly 12-20 minutes earned through new play and decisions rather than global slowdown or inflated durability.
