...
Phase 11 is now underway as a resumable deep-space voyage. Work orders 101-104 established snapshots, public multi-operation maps, the five-sector Null Frontier, and a deterministic mobile carrier. Work order 105 adds six generated boarding contracts across capital ships, stations, wrecks, and derelicts. Optional itinerary nodes project the existing ship combat into four-to-seven-room interiors with bulkheads, subsystem spaces, hazards, custody loot, partial success, and voluntary retreat while retaining the same controls, engineered loadout, items, crew wing, projectiles, collision, objective accounting, pause/resume, and cleanup path. Outcomes can stow carrier claims, recruit specialists, move faction ledgers, recover foundry components, capture rivals, and emit apex-hunt hooks. The fifteen-sector graph still projects 28.15 standard minutes and 36.65 minutes with every optional operation; faction-front, crew-arc, fleetcraft, apex-hunt, and ending work remain in 106-110.
