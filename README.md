...
Phase 11 is now underway as a resumable deep-space voyage. Work orders 101-105 established snapshots, public multi-operation maps, the five-sector Null Frontier, a deterministic mobile carrier, and six room-chain boarding contracts. Work order 106 turns the four faction ledgers into a run-local territory war across every future sector. Aid, theft, contracts, mercy, rivals, boarding, crew ties, and carrier commands move explicit fronts; each faction has distinct alliance, hostility, and opportunist strategies. Fronts can create, transform, or close reserve operations and change encounter ownership, map forecasts, hazards, reinforcements, support, markets, carrier access, recruits, set-piece control, and coalition/siege/fractured ending posture. The fifteen-sector graph still projects 28.15 standard minutes and 36.65 minutes with every optional operation; crew-arc, fleetcraft, apex-hunt, and final ending hardening remain in 107-110.
