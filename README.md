...
Phase 11 is now underway as a resumable deep-space voyage. Work orders 101-106 established snapshots, public multi-operation maps, the five-sector Null Frontier, a deterministic mobile carrier, six room-chain boarding contracts, and a run-local faction territory war. Work order 107 turns the five-person roster into a campaign cast through ten seed-stable, multi-node arcs about bonds, conflicts, fears, ambitions, loyalty, and succession. Mission, carrier, boarding, faction, rival, injury, module, command, and rescue outcomes advance arcs; explicit Crew Quarters choices can promote, pair, rescue, alienate, lose, or name a successor. Rank and relationship effects trade command capacity or formation durability for tactical behavior rather than granting free permanent power. The fifteen-sector graph still projects 28.15 standard minutes and 36.65 minutes with every optional operation; fleetcraft, apex hunts, and final ending hardening remain in 108-110.
