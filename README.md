...
Phase 11 is now underway as a resumable deep-space voyage. Work orders 101-103 established snapshots, public multi-operation maps, and the five-sector Null Frontier with a legitimate Act II extraction. Work order 104 adds a deterministic mobile carrier and concise command deck at clean staging checkpoints: three carrier hull plans each fit four limited slots drawn from seven facility types, carry bounded cargo, accept crew posts, and expose one optional command action per sector. Facilities, posture, damage, heat, debt, pursuit, cargo, and faction access now alter mission availability, engineering salvage, crew recovery, markets, rewards, future support capacity, and boarding capacity. The fifteen-sector graph still projects 28.15 standard minutes and 36.65 minutes with every optional operation; boarding, faction-front, crew-arc, fleetcraft, apex-hunt, and ending work remain in 105-110.
