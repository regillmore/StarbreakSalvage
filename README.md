...
Contract stats now affect hull, speed, hit radius, pickup pull, special charge rate, bomb capacity, and starting credits/salvage. Contract appearance now controls the gameplay ship silhouette, primary/secondary palette, trim, engine color, cockpit accent, weapon mount hints, and future HUD theme key without changing collision or hit radius. Weapon families define projectile pattern, damage, cooldown, heat buildup, vent rate, and overheat reload behavior.
