...
- Contract preview, graphical HUD, and ship combat cue rendering should stay shape-based and cheap until debug/preview smoke shows there is room for richer visuals.
