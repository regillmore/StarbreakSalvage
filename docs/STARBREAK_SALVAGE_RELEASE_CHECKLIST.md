...
- Banked scrap now has a first data-backed upgrade catalog, save-backed purchase helpers, and a visual Upgrade Bay with static original icons; generation effects remain pending Phase 5 work.
- Lunar surface content, sector exit toasts, upgrade generation effects, and richer player destruction are planned but not implemented yet.
