...
Release candidate: Phase 11 dynamic-faction-front voyage workspace

Date: 2026-07-11

## Milestone Status

Phases 1-10 and work orders 101-105 are deployed historical foundations. Work order 106 adds deterministic future-sector faction fronts, structural reserve-node changes, shared ownership/economy/hazard/reinforcement/support/access/ending influence, a tenth Scenario Lab fixture, and snapshot v6 persistence while retaining the live multi-operation, frontier, carrier, and boarding contracts.
...
| Unit/deterministic/integration | Pass   | 86 files, 505 tests                                                                 |
...
| Scenario Lab               | Pass                  | Ten declarative public-model fixtures reach every Phase 10 domain plus carrier, boarding, and dynamic fronts without private app-state mutation or a full run.                                                                                             |
