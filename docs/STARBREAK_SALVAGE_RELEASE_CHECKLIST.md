...
- The current main JavaScript bundle is 916.13 kB minified (249.62 kB gzip) after work order 137 keeps future constellation sectors anonymous until actionable and adds active-sector pulse styling. CSS is 64.05 kB minified/13.24 kB gzip. Several integration modules remain large: `CombatState`, `CanvasRenderer`, `GameApp`, `GameplayScene`, and content validation. These are next-phase scaling warnings, not hidden release exceptions.
