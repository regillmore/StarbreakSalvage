...
Release candidate: Phase 4 display parity increment
Date: 2026-07-04
...
| Unit and deterministic tests  | Pass            | `npm run check` - 32 files, 185 tests                                                |
...
| Item                       | Status | Notes                                                                                                                                                                                                                                                                                         |
| -------------------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Public deployment playable | Pass   | Existing Pages deployment confirmed through 030; WO031 keeps the static Vite build.                                                                                                                                                                                                           |
...
| Debug/performance tools    | Pass   | `?debug=1` supports five boss shortcuts, dense combat stress, quiet long-scroll traversal, forced summary, granular entity/projectile/pickup/effect/feature counters, distance/speed/arena counters, background primitive/layer count, viewport scale, safe-frame size, and fixed world size. |
...
| Accessibility         | Watch  | Keyboard flow, remapping, mute, reduced motion, shake strength, contrast, HUD wrapping, fixed-arena safe-frame scaling, and high-contrast bullets exist; manual mobile and contrast checks remain. |
...
- The debug overlay reports granular entity, scroll/background/feature, viewport, safe-frame, and fixed-world counts; frame-time sampling and allocation timing remain future instrumentation work.
- Phase 4 display/input work remains partial: first-pass fixed-arena window-size parity exists, while mouse controls, contract ship appearance, ship previews, and graphical HUD theming are not implemented yet.
