...
import { createUpgradeBayViewModel, type UpgradeBayViewModel } from '../../src/ui/UpgradeBayViewModel';
...
describe('createUpgradeBayViewModel', () => {
  it('summarizes banked scrap, available upgrades, and icon categories', () => {
    ...
    expect(model.summaryText).toBe('Bank 4 kg | Installed 0/6 | Ready 2');
  ...
  it('shows purchased and locked upgrade states with prerequisite names', () => {
    ...
    expect(model.summaryText).toBe('Bank 12 kg | Installed 1/6 | Ready 2');
